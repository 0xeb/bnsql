#!/usr/bin/env python3
"""
Converts bnsql_agent.md to a C++ header with embedded raw string literal.
Only regenerates if the hpp is older than the md or doesn't exist.

Run: python scripts/embed_prompt.py prompts/bnsql_agent.md src/common/bnsql_agent_prompt.hpp
"""
